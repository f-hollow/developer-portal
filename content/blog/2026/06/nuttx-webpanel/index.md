...
The following screenshot shows NuttX Web Panel running on an ESP32-P4, accessible at `http://webpanel.local`:
...
{{< youtubeLite id="UJo0rS__jpk" label="NuttX Webpanel Demo" >}}
